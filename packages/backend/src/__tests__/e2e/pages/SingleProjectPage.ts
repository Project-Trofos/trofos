...
export default class SingleProjectPage {
  ...
  async selectBacklogReporter(reporterId: string) {
    ...
    await this.driver
      .findElement(By.xpath(`//div[@id='reporterId_list']/following-sibling::div//span[text()='${reporterId}']`))
      .click();
  }
  ...
  async selectBacklogAssignee(assigneeId: string) {
    ...
    await this.driver
      .findElement(By.xpath(`//div[@id='assigneeId_list']/following-sibling::div//span[text()='${assigneeId}']`))
      .click();
  }
