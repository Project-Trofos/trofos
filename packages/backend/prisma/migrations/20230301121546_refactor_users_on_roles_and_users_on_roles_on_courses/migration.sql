/*
  ...
  - Added the required column `user_id` to the `UsersOnRoles` table without a default value. This is not possible if the table is not empty.
  - Added the required column `user_id` to the `UsersOnRolesOnCourses` table without a default value. This is not possible if the table is not empty.
